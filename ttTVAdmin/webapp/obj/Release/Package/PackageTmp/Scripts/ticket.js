...
Ticket.format = function (d) {
    ...
    return '<div class="well">' +
        '<div class="row">' +
            ...
            '</div>' +
            '<div class="col-md-8">' +
                Ticket.formatModalButton(d.TicketId, 'Details', d.Details) +
                d.Details +
            '</div>' +
        ...
        '</div><div class="row">' +
            ...
            '<div class="col-md-4">' +
                ...
                '<form action="/" class="dropzone" id="ticketDropzone' + d.TicketId + '" enctype="multipart/form-data" method="post">' +
...
Ticket.formatModalButton = function (tid, field, ovalue) {
